...
export const Box = ({count, description}) => {
    return (
        <div className="p-3 md:py-5 md:px-6 lg:py-6 lg:px-12 xl:p-8 rounded-lg border border-solid border-[#dbdbdb] text-center shadow-lg w-full">
            <p className="text-[13px] xs:text-[15px] lg:text-[20px] xl:text-[25px] font-semibold xl:font-bold mb-2">{count}</p>
            <p className="text-[12px] xs:text-[14px] lg:text-[18px] xl:text-[22px] font-medium">{description}</p>
        </div>
    )
}
    ...
    return (
        <div className="p-5 xs:p-6 sm:p-8 rounded-lg border border-solid border-[#dbdbdb] shadow-lg w-full md:w-[60%] flex flex-col gap-8">
            <figure className="flex items-center flex-col md:flex-row gap-5 justify-center">
                ...
                <figcaption className="text-[16px] xs:text-[18px] md:text-[20px] lg:text-[25px] xl:text-[30px] font-semibold text-[#1a1a1a]">Open Source</figcaption>
            </figure>
            <p className="text-[13px] xs:text-[14px] lg:text-[15px] xl:text-[18px]">
    ...
    return (
        <div className="p-5 xs:p-6 sm:p-8 rounded-lg border border-solid border-[#dbdbdb] shadow-lg w-full md:w-[40%] text-center">
            <figure className="flex flex-col justify-center items-center gap-4 mb-5">
                ...
                <figcaption className="text-[16px] xs:text-[20px] lg:text-[25px] xl:text-[30px] font-semibold text-[#1a1a1a]">LessCode Comunity</figcaption>
                <span className="text-[16px] xs:text-[18px] sm:text-[20px] xl:text-[25px] font-medium xl:font-semibold text-[#2A9D8F]">&bull; 1199 online</span>
            </figure>
            <Join />
        </div>
    )
