    ...
    return (
        <>
            ...
            <div className="p-5 xs:p-6 sm:p-8 border border-solid border-[#dbdbdb] rounded-xl shadow-lg flex justify-between items-center gap-5">
                <p className="text-left text-[13px] md:text-[14px] lg:text-[16px] text-[#1a1a1a]">{paragraf}</p>
            ...
            <div className={angle ? "hidden" : "block"}>
                <div className="border-b border-l border-r rounded-lg -mt-6 pt-8 p-5 xs:p-6 sm:p-8 shadow-lg">
                    <p className="text-left text-[13px] md:text-[14px] lg:text-[16px] text-[#1a1a1a]">{desc}</p>
                </div>
            </div>
        </>
    )
