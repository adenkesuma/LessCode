...
<<<<<<< HEAD
        <button className="w-full md:w-full bg-[#E53D19] py-4 px-6 md:py-2 md:px-4 rounded-lg text-white text-[14px] md:text-[14px] font-light">
...
>>>>>>> b426266afa1cc67ca965d3fb24fe7fcd59d2f75d
          <Link href="/auth/signUp">Mulai Sekarang</Link>
>>>>>>> 0fa4c861bc046eb5b8f1414773c604645853e9b7
        </button>
      </div>
    );
}
...
export const SignIn = () => {
    return (
      <div className="flex justify-center">
<<<<<<< HEAD
        <button className="w-full md:w-full py-3 px-6 md:py-3 pmd:px-8 bg-white border-solid border-2 border-[#E53D19] md:px-6 xl:py-[12px] text-[14px] md:text-[16px] font-medium rounded-lg text-[#E53D19]">          <Link href="/auth/signIn">Sign In</Link>
=======
<<<<<<< HEAD
